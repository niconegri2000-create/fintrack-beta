...
import { DashboardPeriodPicker, type DashboardPeriodPreset, presetToLocalRange } from "./DashboardPeriodPicker";
...
export function BudgetWidget() {
  ...
  const filtered = budgetRows.filter((b) => b.monthly_limit > 0);
